          ...
          <div v-if="dataSource === 'database'" class="mt-4">
            <v-card variant="outlined" class="pa-4">
              ...
              <v-row class="child-mbm-2">
                <v-col cols="12" md="6">
                  <v-text-field v-model="dbConfig.host" label="数据库主机" variant="outlined"
              ...
              <div v-for="(table, index) in dbTables" :key="index" class="mb-4">
                <v-card variant="outlined" class="pa-3">
                  ...
                  <v-row class="">
                    ...
                    <v-col cols="12" md="3">
                      <v-combobox v-model="table.primaryKeys" label="主键名" multiple chips closable-chips
                        variant="outlined" density="compact" hint="支持联合主键，输入后按回车添加" persistent-hint></v-combobox>
                    </v-col>
                    <v-col cols="12" md="3">
          ...
          <div v-if="isDataProcessed">
            ...
            <div class="data-table-container mt-3">
              <v-data-table :items="paginatedData" :headers="headers" :items-per-page="10" hide-default-footer
                item-key="id" class="data-table-no-wrap" items-per-page-text="每页显示">
